...
Estimated condutances with associated uncertainties are available [**here**](#).

`icBuilder` is NOT intended for reading the esimated conductances. Instead use the lightweight `icReader` available [**here**](#).
